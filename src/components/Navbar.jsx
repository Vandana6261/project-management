      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary p-[2px]">
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              <Link
                to="/dashboard"
                className="rounded-xl bg-primary hover:bg-primaryHover text-xs uppercase font-extrabold tracking-widest text-white py-2.5 px-5 shadow-lg shadow-primary/15 transition-all duration-200"
              >
                Go to App
              </Link>
            ) : (
